...
class Tree:
    ...
    def buscar(self, valor, nohAtual = -1):
        ...
        if nohAtual is None:
            ...
            if nohAtual.data == valor:
                return True
        
            if valor < nohAtual.data:
                return self.buscar(valor, nohAtual.left)
            else:
                return self.buscar(valor, nohAtual.right)
        
    def strInOrder(self, nohAtual = -1, 
                         strTree = "" ):
        ...
        strTree += self.strInOrder( nohAtual.left )
        
        strTree += " " + str(nohAtual.data)
        strTree += self.strInOrder( nohAtual.right )
        
        return strTree
    
    def strPosOrder(self, nohAtual= -1,
                          strTree = ""):
        ...
        strTree += self.strPosOrder( nohAtual.left )
        strTree += self.strPosOrder( nohAtual.right )
        strTree += " " + str(nohAtual.data)
...
if __name__ == "__main__":
    ...
    encontrou = tree1.buscar(6)
    print("buscar(6): ", encontrou)
    
    info1 = tree1.strInOrder()
    print('strInOrder():', info1)
    
    info1 = tree1.strPosOrder()
    print('strPosOrder():', info1)
